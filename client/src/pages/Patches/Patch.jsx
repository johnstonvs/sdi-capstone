          ...
          <div className='bg-gray-700/25 mt-28 p-6 rounded-xl shadow-xl m-auto fade-in h-full w-2/3'>
            <div className='PatchContainer flex flex-row items-start relative'>
              ...
              <div>
                ...
                <p className='PatchPrice text-white mt-20 w-full'>{patch.description}</p>
              </div>
                <button className='text-white p-2 rounded-md bg-[#FF3300] hover:bg-[#FF9980] hover:scale-105 absolute top-0 right-0' onClick={() => setShowReportForm(true)} >
