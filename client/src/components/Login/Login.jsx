...
const Login = () => {
  ...
  return (
      <form className='LoginContainer bg-gray-300 flex flex-col justify-center p-4 rounded shadow-inner w-96' onSubmit={authenticate}>
        ...
        <input className='LoginEmail w-full p-2 mb-4 bg-white rounded-md shadow mt-1' name='email' value={user.email} placeholder='Enter your military email...' type='text' required onChange={(e) => handleChange(e)} />
