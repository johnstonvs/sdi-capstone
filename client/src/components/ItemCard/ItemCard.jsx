...
const ItemCard = ({ item }) => {
  ...
  return (
    <div className='ItemCardContainer bg-gray-300 flex flex-col justify-center p-4 rounded shadow-inner gap-3 hover:scale-105'>
      <img className='ItemImage h-52 object-cover object-center w-40 h-40' src={item.picture_url} />
