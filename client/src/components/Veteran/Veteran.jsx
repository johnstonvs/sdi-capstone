...
const Veteran = ({ baseList, sendToLogin, user, setUser }) => {
    ...
    return (
        <div>
            <form className='VeteranContainer bg-gray-300 flex flex-col justify-center p-4 rounded shadow-inner w-96' onSubmit={submit}>
                ...
                <label name='DD214' className='BodyLabel text-[#222222]'>File:</ label>
                <input className='FileButt w-full p-2 border-2 border-[#45A29E] rounded mb-4' accept='.pdf' type='file' onChange={(e) => { setPdfUrl(e.target.files[0]) }} />
